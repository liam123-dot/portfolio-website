  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <Head>
        ...
        <meta name="description" content="Portfolio website of Liam Buchanan - Portfolio" />
        ...
        <header className="mb-12 flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-gray-700 dark:text-gray-300">
              ...
              with intermediate/advanced skills in Typescript/Javascript, Next.js/React.js, and Java. Through my university degree and a lot of
              self teaching, I also have good knowledge of REST APIs, web scraping, Docker, AWS, and asynchronous development.
            </p>
          </div>
        </header>
